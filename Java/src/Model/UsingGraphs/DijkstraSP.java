 ...
 *
 *  % java Module.DijkstraSP tinyEWD.txt 0
 *  0 to 0 (0.00)  
 ...
 *
 *  % java Module.DijkstraSP mediumEWD.txt 0
 *  0 to 0 (0.00)  
...
/**
 *  The <tt>Module.DijkstraSP</tt> class represents a data type for solving the
 *  single-source shortest paths problem in edge-weighted digraphs
 *  where the edge weights are nonnegative.
 *  <p>
 *  This implementation uses Dijkstra's algorithm with a binary heap.
 *  The constructor takes time propo--rtional to <em>E</em> log <em>V</em>,
...
public class DijkstraSP {
    ...
    /**
     * Unit tests the <tt>Module.DijkstraSP</tt> data type.
     */
    public static void main(String[] args) {
        /*
        In in = new In(args[0]);
        Module.EdgeWeightedDigraph G = new Module.EdgeWeightedDigraph(in);
        int s = Integer.parseInt(args[1]);

        // compute shortest paths
        Module.DijkstraSP sp = new Module.DijkstraSP(G, s);
        ...
        for (int t = 0; t < G.V(); t++) {
            if (sp.hasPathTo(t)) {
                ...
                if (sp.hasPathTo(t)) {
                    for (Module.DirectedEdge e : sp.pathTo(t)) {
                        StdOut.print(e + "   ");
                    }
                }
                StdOut.println();
